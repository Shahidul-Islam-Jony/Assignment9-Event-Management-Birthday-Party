...
const PartyTheme = () => {
    return (
        <div className="flex flex-col lg:flex-row items-center md:my-16 gap-8">
            <div className="text-center my-14" data-aos="fade-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mb-8 gap-4">
                <div className="bg-base-100 shadow-xl lg:w-96" data-aos="flip-left"  data-aos-duration="2000">
                    <Link><img className="rounded-lg" src="/src/assets/partyTheme/PartyTheme1.jpg"/></Link>
                </div>
                <div className="bg-base-100 shadow-xl lg:w-96" data-aos="flip-right"  data-aos-duration="2000">
